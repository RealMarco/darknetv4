...
img_dir = '/home/marco/catkin_workspace/src/darknet_ros/darknet/RPdevkit/RP2007/JPEGImagesShoesStatesTesting/'
...
for ids in cropped_img_ids:
    ...
    cropped_img = img[int(ymin*0.9):int(ymax*1.1), int(xmin*0.9):int(xmax*1.1)] # [ymin:ymax, xmin:xmax]
...
print('10 min confidence after non-maximum suppression/threshold filtering:')
